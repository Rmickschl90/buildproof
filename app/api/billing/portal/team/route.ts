...
export async function POST(req: NextRequest) {
  try {
    ...
    // matching comment for the full explanation. Now wired to the
    // dashboard's Manage Billing button for org owners (billingSource ===
    // "organization"), see app/dashboard/page.tsx.
    params.append(
      "return_url",
